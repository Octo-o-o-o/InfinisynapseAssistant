...
| 桌面 / 原生 BYOK 接入 | `docs/playbooks/desktop-native-byok.md` | `docs/playbooks/secure-integration.md`, `docs/reference/task-lifecycle.md` |
| 鸿蒙（HarmonyOS）app 接入 | `docs/playbooks/harmonyos-app-integration.md` | `docs/playbooks/secure-integration.md`, `docs/reference/task-lifecycle.md` |
| 测试集成代码 / 评估 app 质量 | `docs/playbooks/testing-and-evaluation.md` | `samples/mock-server/README.md`, `docs/playbooks/decision-quality-loop.md` |
...
| 决策包质量闭环 / Outcome 回访 / Watchlist delta / benchmark | `docs/playbooks/decision-quality-loop.md` | `docs/playbooks/artifact-archiving.md`, `infinisynapse-product-patterns` skill |
...
| 「使用 InfiniSynapse 登录」/ 任务计费记用户账号 | `docs/playbooks/partner-sso-account-billing.md` | `docs/reference/api-index.md` §8, 上游 `partner-sso-integration-guide.md` |
...
| `docs/playbooks/` | 基于官方事实总结的核心场景做法（LLM 路由、安全接入、桌面 BYOK、鸿蒙 app、RAG、Browser Use、分享、测试与评估等） | AI/人类友好 + 特定用法内容 |
...
| `docs/plans/` | 阶段性调研与实施方案工作稿（如 `*.cursor.fable.md`；记录过程，不是规范入口） | 人类友好 |
