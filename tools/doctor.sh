...
require_file "docs/playbooks/llm-routing.md"
require_file "docs/playbooks/desktop-native-byok.md"
require_file "docs/playbooks/existing-product-integration.md"
require_file "docs/playbooks/artifact-archiving.md"
require_file "docs/playbooks/decision-quality-loop.md"
